...
FRONTEND - ReactJS, HTML, CSS, Vanilla Javascript, Material UI, react-router-dom, axios, notistack, dayjs, Bootstrap, Figma.</br>
BACKEND -  NodeJs, Express, MongoDB, Mongoose ODM, Postman, JSON Web Token, bcrypt (password hashing), joi, cors, SQL, Stored Procedures </br>
